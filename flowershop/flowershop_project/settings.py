...
STATIC_QRPH_IMAGE_URL = config('STATIC_QRPH_IMAGE_URL', default='')
STATIC_QRPH_MERCHANT_NAME = config('STATIC_QRPH_MERCHANT_NAME', default='Joseph Flowershop')
STATIC_QRPH_CONTACT_NUMBER = config('STATIC_QRPH_CONTACT_NUMBER', default='09124169887')
