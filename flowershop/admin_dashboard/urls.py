...
urlpatterns = [
    ...
    path('custom-bouquets/', views.custom_bouquet_list, name='custom_bouquets'),
    path('deliveries/', views.delivery_schedule, name='delivery_schedule'),
    path('deliveries/<int:delivery_id>/status/', views.update_delivery_quick_status, name='delivery_quick_status'),
